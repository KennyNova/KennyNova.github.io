...
export const Contactbuttons = () => {
    return (
        <div className="grid lg:grid-cols-3 grid-cols-1 place-items-center">
            <a className="github-button inline-block  mt-10 lg:m-auto w-72" href="https://github.com/KennyNova" target="_blank" rel="noopener noreferrer">
              <img className="contact-image githubimg float-left w-8 mr-0 " src={github} alt="github-icon" />
              GitHub
              <p className="subtext">(Click to visit)</p>
            </a>
            <a className="email-button inline-block max-h-24 text-base mt-10 lg:m-auto md:w-auto lg:w-96" onClick={() => { navigator.clipboard.writeText("NavidM4598@gmail.com") }}>
            ...
            <a className="resume-button inline-block mt-10 lg:m-auto w-72 " href={resume} download>
